...
export class IndiTestYesavage extends React.Component {
  render() {
    return (
      <ImageBackground source={bgImage} style={styles.backgroundContainer}>
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.TextInfotitu}>Puntos de cortes:
            </Text>
          </View>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.TextInfoparr}>El evaluador lee las preguntas al paciente sin realizar interpretaciones de los ítems y dejando claro al paciente que la respuesta no debe ser muy meditada. Las respuesta debe ser "si" o "no" y debe referirse a cómo se ha sentido el paciente la semana anterior.</Text>
          </View>
...
export default IndiTestYesavage;
