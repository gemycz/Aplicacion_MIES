  ...
  render(){
    return (
      ...
      <ImageBackground source={bgImage} style={styles.backgroundContainer} >
        ...
        <Text style={styles.text}>El adulto mayor puede realizar el Test con el acompañamiento únicamente en su domicilio.</Text>  
        </View>
        <View style={styles.ContainerText}>
        <Text style={styles.textSub}>Antes de realizar los Tests debe informar sobre el sitio donde se está llevando a cabo.</Text>  
        </View>
