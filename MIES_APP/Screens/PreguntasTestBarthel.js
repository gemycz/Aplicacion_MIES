            ...
            <ImageBackground source={bgImage} style={styles.backgroundContainer}>
                <ScrollView style={styles.scrollView}>
                    ...
                    <View style={styles.tituloLabel}>
                        <Text style={styles.TextInfo}>A continuación encontrará 10 ítems correspondientes a actividades
                            básicas de la
                            vida diaria. Lea en voz alta las alternativas pertenecientes a cada una de ellas y solicite
                            a la persona evaluada
                            que escoja la que más coincida con la realidad de la persona adulta mayor. La información se
                            obtiene preguntando
                    ...
                    <View style={styles.radioButton}>
                        <RadioButton.Group
                            ...
                            <View style={{flexDirection: 'row'}}>
                                ...
                                <Text style={styles.TextRadio1}>Necesita alguna ayuda, pero puede hacer algo
                                    solo. </Text>
                            </View>
                            ...
                            <View style={{flexDirection: 'row'}}>
                                ...
                                <Text style={styles.TextRadio1}>Independiente (entrar y salir, limpiarse y
                                    vestirse).</Text>
                            </View>
                        </RadioButton.Group>
                    </View>
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <View>
                                    <RadioButton
                                        ...
                                        onPress={() => {
                                            this.setState({checked5: 'tres'});
                                        }}/>
                                </View>
                                <Text style={styles.TextRadio1}>Anda con pequeña ayuda de una persona (física o
                                    verbal). </Text>
                            </View>
                    ...
                    <View style={styles.radioButton}>
                        <RadioButton.Group
                            ...
                            <View style={{flexDirection: 'row'}}>
                                ...
                                <Text style={styles.TextRadio1}>Incontinente, (o necesita que le suministren
                                    enema).</Text>
                            </View>
                    ...
                    <View style={styles.radioButton}>
                        <RadioButton.Group
                            ...
                            <View style={{flexDirection: 'row'}}>
                                ...
                                <Text style={styles.TextRadio1}>Incontinente o sondado incapaz de cambiarse la
                                    bolsa. </Text>
                            </View>
                    ...
                    <View style={{flex: 1, flexDirection: 'row', justifyContent: 'center'}}>
                        ...
                        <TouchableOpacity style={styles.btnCancelar}
                                          onPress={() => this.props.navigation.navigate('TestBarthel')}>
