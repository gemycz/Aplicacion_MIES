...
export class PreguntasTestMiniExamenMental extends React.Component {
  ...
  registroUsuario = () => {
    ...
    fetch('http://192.168.100.18/pruebas_react/registrarse.php', {
      method: 'POST',
      headers: {
    ...
    return (
      <ImageBackground source={bgImage} style={styles.backgroundContainer}>
        <ScrollView style={styles.scrollView}>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked1: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked1: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked2: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked2: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked3: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked3: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked4: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked4: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked5: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked5: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked6: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked6: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked7: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked7: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked8: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked8: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked9: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked9: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.TextInfo}>CONSIGNA: “Le voy a decir el nombre de tres objetos, cuando yo termine quiero que por favor usted los
            repita”.</Text>
            <Text style={styles.TextInfo1}>*Pronuncie claramente las palabras, una cada segundo, luego pídale a persona adulta mayor, que las repita.
            Otorgue un punto por cada respuesta correcta. Se repiten las palabras hasta que la persona se las aprenda
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked10: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked10: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked11: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked11: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked12: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked12: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.TextInfo}>CONSIGNA:  “Le voy a pedir que reste de 7 en 7 a partir del 100”.</Text>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked13: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked13: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked14: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked14: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked15: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked15: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked15: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked16: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked16: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked16: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
              ...
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked17: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked17: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.TextInfo}>CONSIGNA: “Dígame los 3 objetos que le mencioné al principio”.</Text>
          </View>
          <View style={styles.tituloLabel}>
            <Text style={styles.label}>Papel
            </Text>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked18: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked18: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked18: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked19: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked19: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked19: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked20: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked20: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked20: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked21: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked21: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked21: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked22: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked22: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.TextInfo}>CONSIGNA: “Ahora le voy a decir una frase que tendrá que repetir después de mí. Solo se
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked23: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked23: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked23: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.TextInfo}>CONSIGNA:  “Le voy a dar unas instrucciones. Por favor sígalas en el orden en que las voy a decir. Solo las
            puedo decir una vez”:</Text>
            <Text style={styles.TextInfo1}>“TOME ESTE PAPEL CON LA MANO DERECHA, DÓBLELO POR LA MITAD Y DÉJELO EN EL SUELO”</Text>
          </View>
          <View style={styles.tituloLabel}>
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked24: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked24: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked24: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked25: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked25: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked25: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked26: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked26: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked26: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.label}>Escriba legiblemente en un papel "cierre los ojos". Pídale a la persona adulta mayor que
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked27: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked27: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={styles.tituloLabel}>
            <Text style={styles.label}>CONSIGNA:   “Quiero que por favor escriba una frase que diga un mensaje”
            </Text>
          </View>
          <View style={{ alignItems: 'center' }}>
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked28: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked28: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked28: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <RadioButton.Group
              onValueChange={(v) => { this.setState({ checked29: v }) }}>
              <View style={{ flexDirection: 'row' }}>
                <View>
                  ...
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked29: 'uno' }); }} />
                </View>
                <Text style={styles.TextRadio1}>0 (Incorrecto)</Text>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked29: 'dos' }); }} />
                </View>
                <Text style={styles.TextRadio2}>1 (Correcto) </Text>
              </View>
            </RadioButton.Group>
