        ...
        return (
            <ImageBackground source={bgImage} style={styles.backgroundContainer}>
                <Content padder>
                    ...
                    <Text style={styles.Titulo}><Text style={{fontWeight: 'bold', fontSize: 18, textAlign: 'left'}}>Adulto
                        Mayor:</Text> {this.state.nombre + ' ' + this.state.apellido}.</Text>
                    <View style={{flexDirection: 'row', justifyContent: 'center', marginTop: 40}}>
                        <View style={{alignItems: 'center', marginRight: 50}}>
                            <TouchableOpacity
                                style={{width: 125, height: 125, borderRadius: 90, justifyContent: 'center'}}
                                onPress={this.Ubicacion}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'center', marginTop: 50}}>
                        <View style={{alignItems: 'center', marginRight: 50}}>
                            <TouchableOpacity
                                style={{width: 125, height: 125, borderRadius: 90, justifyContent: 'center'}}
                                onPress={this.IndiTestLawtonBrody}>
                                <View style={{alignItems: 'center'}}>
                        ...
                        <View style={{alignItems: 'center', marginLeft: 50}}>
                            <TouchableOpacity
                                style={{width: 125, height: 125, borderRadius: 90, justifyContent: 'center'}}
                                onPress={this.TestMiniExamenMental}>
                                <View style={{alignItems: 'center'}}>
