              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked: cero }); }}
                  />
                </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked1: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked2: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked3: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked4: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked5: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked6: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked7: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked8: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked9: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked10: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked11: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked12: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked13: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                  <RadioButton
                    ...
                    onPress={() => { this.setState({ checked14: cero }); }}
                  />
                </View>
                <Text style={styles.TextRadio}>No</Text>
              </View>
