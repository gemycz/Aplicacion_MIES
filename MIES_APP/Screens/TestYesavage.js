  ...
  registroEncabezado = async () => {
    ...
    return await fetch('http://192.168.100.18/pruebas_react/registraEnca.php', {
      ...
      .then((responseJson) => {
        ...
        if (responseJson === "Ok") {
          //alert("Bienvenido");
          Alert.alert('Registro de Información', 'Datos Registrados correctamente...', [{ text: 'Continuar', onPress: () => this.props.navigation.navigate('PreguntasYesavage'), style: 'destructive' }]);
        } else {
