...
export class TestYesavage extends React.Component {
    ...
    registroEncabezado = async () => {
        ...
        return await fetch('http://192.168.100.18/pruebas_react/registraEnca.php', {
            method: 'POST',
            headers: {
            ...
            .then((responseJson) => {
                ...
                if (responseJson === "Ok") {
                    ...
                    Alert.alert('Registro de Información', 'Datos Registrados correctamente...', [{
                        text: 'Continuar',
                        onPress: () => this.props.navigation.navigate('PreguntasYesavage'),
                        style: 'destructive'
                    }]);
                } else {
                ...
                <ScrollView style={styles.scrollView}>
                    ...
                    <View style={styles.errorContainer}>
                        <Text style={[styles.TextDefault, !this.state.unidadAtencionValidate ? styles.TextError : null,
                            this.state.unidadAtencionValidate ? styles.TextErrorValid : null]}>Solo se permiten
                            letras</Text>
                    </View>
                    <View style={{flexDirection: 'row', width: '90%', marginTop: 10, paddingRight: 5, paddingLeft: 5,}}>
                        <View style={{marginLeft: 20, marginRight: 30}}>
                            ...
                            <View style={styles.errorContainer}>
                                <Text style={[styles.TextDefault, !this.state.zonaValidate ? styles.TextError : null,
                                    this.state.zonaValidate ? styles.TextErrorValid : null]}>Solo se permiten
                                    letras</Text>
                            </View>
                        </View>
                        ...
                        <View style={{alignItems: 'flex-end'}}>
                            ...
                            <View style={styles.errorContainer}>
                                <Text
                                    style={[styles.TextDefault, !this.state.distritoValidate ? styles.TextError : null,
                                        this.state.distrito ? styles.TextErrorValid : null]}>Solo se permiten
                                    letras</Text>
                            </View>
                        </View>
                    ...
                    <View style={styles.errorContainer}>
                        <Text style={[styles.TextDefault, !this.state.edadValidate ? styles.TextError : null,
                            this.state.edadValidate ? styles.TextErrorValid : null]}>Debe ingresar hasta 3 digitos
                            numéricos</Text>
                    </View>
                    ...
                    <View style={styles.errorContainer}>
                        <Text style={[styles.TextDefault, !this.state.aplicadoPorValidate ? styles.TextError : null,
                            this.state.aplicadoPorValidate ? styles.TextErrorValid : null]}>Solo se permiten
                            letras</Text>
                    </View>

                    <View style={{flexDirection: 'row'}}>
                        <Text style={{marginTop: 20, fontSize: 16, marginLeft: 25, fontWeight: 'bold'}}>Fecha de
                            Realización: </Text>
                    ...
                    <View style={{flex: 1, flexDirection: 'row', justifyContent: 'center'}}>
                        ...
                        <TouchableOpacity style={styles.btnCancelar}
                                          onPress={() => this.props.navigation.navigate('IndiTestYesavage')}>
