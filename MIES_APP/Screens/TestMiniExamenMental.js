...
export class TestMiniExamenMental extends React.Component {
                ...
                <ScrollView style={styles.scrollView}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-evenly', width: '100%'}}>
                        <TouchableOpacity style={styles.btnRegistrar}
                                          onPress={() => this.props.navigation.navigate('PreguntasMiniExamenMental')}>
...
export default TestMiniExamenMental;
