...
export class RegistroAM extends Component {
            ...
            .then((responseJson) => {
                if (responseJson === "Ok") {
                    ...
                    Alert.alert('Registro de Información', 'Datos Registrados correctamente...',
                        [{
                            text: 'Continuar',
                            onPress: () => this.props.navigation.navigate('ListaAM'),
                            style: 'destructive'
                        }]);
    ...
    validateNombre(nombres, type) {
        var alph = /^[a-zA-ZÀ-ÿ]+(\s*[a-zA-ZÀ-ÿ]*)*[a-zA-ZÀ-ÿ]+$/g
        if (type === 'nombres') {
                ...
                <ScrollView style={styles.scrollView}
                    ...
                    <View style={styles.errorContainer}>
                        <Text style={[styles.TextDefault, !this.state.cedulaValidate ? styles.TextError : null,
                            this.state.cedulaValidate ? styles.TextErrorValid : null]}>Debe ingresar 10 digitos
                            numéricos</Text>
                    </View>
                    <View style={styles.inputContainer}>
