  ...
  render(){
    ...
    return (
      ...
      <View style={styles.tituloContainer}>
        ...
        <View style={styles.tituloLabel}>
            ...
            A continuación encontrará 8 ítems correspondientes a actividades instrumentales de la vida diaria.</Text>        
        </View>
       ...
       <View style={styles.radios} >
       <Text style={styles.TextRadio}>Es capaz de contestar al teléfono, pero no de marcar</Text>
       <RadioButton 
          value="tres"
      ...
      <View style={styles.tituloLabel}>
       ...
       <View style={styles.radios} >
         <Text style={styles.TextRadio}>Realiza todas las compras necesarias independientemente</Text>
       <RadioButton 
          value="cinco"
       ...
       <RadioButton 
          ...
          onPress={() => { this.setState({ checked2: 'siete' }); }}
        />
       </View>
       <View style={styles.radios} >
       ...
       <RadioButton 
          ...
          onPress={() => { this.setState({ checked2: 'ocho' }); }}
        />
       </View>
       </RadioButton.Group>
      </View>
       ...
       <View style={styles.radios2} >
         <Text style={styles.TextRadio2}>Organiza, prepara y sirve las comidas por si solo adecuadamente</Text>
       <RadioButton 
          value="nueve"
          status={checked3 === 'nueve' ? 'checked' : 'unchecked'}
          onPress={() => { this.setState({ checked3: 'nueve' }); }}
        />
       </View>
       <View style={styles.radios2} >
       <Text style={styles.TextRadio2}>Prepara adecuadamente las comidas si se le proporcionan los ingredientes</Text>
       <RadioButton 
          value="diez"
          status={checked3 === 'diez' ? 'checked' : 'unchecked'}
          onPress={() => { this.setState({ checked3: 'diez' }); }}
        />
       </View>
       <View style={styles.radios2} >
       <Text style={styles.TextRadio2}>Prepara, calienta y sirve las comidas, pero no sigue una dieta adecuada</Text>
       <RadioButton 
          value="once"
          status={checked3 === 'once' ? 'checked' : 'unchecked'}
          onPress={() => { this.setState({ checked3: 'once' }); }}
        />
       </View>
       <View style={styles.radios2} >
       ...
       <RadioButton 
          ...
          onPress={() => { this.setState({ checked3: 'doce' }); }}
        />
       </View>
       </RadioButton.Group>
      </View>
      ...
      <View style={styles.tituloLabel}>
       ...
       <View style={styles.radios} >
         <Text style={styles.TextRadio2}>Mantiene la casa solo o con ayuda ocasional ( para trabajos pesados) </Text>
       <RadioButton 
          value="trece"
          status={checked4 === 'trece' ? 'checked' : 'unchecked'}
          onPress={() => { this.setState({ checked4: 'trece' }); }}
        />
       </View>
       <View style={styles.radios2} >
       <Text style={styles.TextRadio2}>Realiza tareas ligeras, como lavar los platos o hacer las camas </Text>
       <RadioButton 
          value="catorce"
          status={checked4 === 'catorce' ? 'checked' : 'unchecked'}
          onPress={() => { this.setState({ checked4: 'catorce' }); }}
        />
       </View>
       <View style={styles.radios2} >
       <Text style={styles.TextRadio2}>Realiza tareas ligeras, pero no puede mantener un adecuado nivel de limpieza</Text>
       <RadioButton 
          value="quince"
          status={checked4 === 'quince' ? 'checked' : 'unchecked'}
          onPress={() => { this.setState({ checked4: 'quince' }); }}
        />
       </View>
       <View style={styles.radios2} >
       ...
       <RadioButton 
          ...
          onPress={() => { this.setState({ checked4: 'dieciseis' }); }}
        />
       </View>
       <View style={styles.radios} >
       ...
       <RadioButton 
          ...
          onPress={() => { this.setState({ checked4: 'diecisiete' }); }}
        />
       </View>
       </RadioButton.Group>
      </View>
      <View style={styles.tituloLabel}>
       ...
       <RadioButton 
          ...
          onPress={() => { this.setState({ checked5: 'dieciocho' }); }}
        />
       </View>
       <View style={styles.radios} >
       ...
       <RadioButton 
          ...
          onPress={() => { this.setState({ checked5: 'diecinueve' }); }}
        />
       </View>
       <View style={styles.radios} >
       <Text style={styles.TextRadio}>Todo el lavado de ropa debe ser realizado por otro</Text>
       <RadioButton 
          value="veinte"
          status={checked5 === 'veinte' ? 'checked' : 'unchecked'}
          onPress={() => { this.setState({ checked5: 'veinte' }); }}
        />
       </View>
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked6: 'veintiuno' }); }}
      />
     </View>
     <View style={styles.radios} >
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked6: 'veintidos' }); }}
      />
     </View>
     <View style={styles.radios2} >
     <Text style={styles.TextRadio2}>
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked6: 'veintitres' }); }}
      />
     </View>
     <View style={styles.radios2} >
     <Text style={styles.TextRadio}>Utiliza el taxi o el automóvil sólo con la ayuda de otros </Text>
     <RadioButton 
        value="veinticuatro"
        status={checked6 === 'veinticuatro' ? 'checked' : 'unchecked'}
        onPress={() => { this.setState({ checked6: 'veinticuatro' }); }}
      />
     </View>
     <View style={styles.radios} >
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked6: 'veinticinco' }); }}
      />
     </View>
     </RadioButton.Group>
    </View>
    ...
    <View style={styles.tituloLabel}>
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked7: 'veintiseis' }); }}
      />
     </View>
     <View style={styles.radios} >
     <Text style={styles.TextRadio}>
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked7: 'veintisiete' }); }}
      />
     </View>
     <View style={styles.radios} >
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked7: 'veintiocho' }); }}
      />
     </View>
    ...
    <View style={styles.tituloLabel}>
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked8: 'veintinueve' }); }}
      />
     </View>
     <View style={styles.radios} >
     <Text style={styles.TextRadio2}>Realiza las compras de cada día, pero necesita ayuda con las grandes compras y en los
bancos </Text>
     <RadioButton 
        value="treinta"
        status={checked8 === 'treinta' ? 'checked' : 'unchecked'}
        onPress={() => { this.setState({ checked8: 'treinta' }); }}
      />
     </View>
     <View style={styles.radios2} >
     ...
     <RadioButton 
        ...
        onPress={() => { this.setState({ checked8: 'treintaiuno' }); }}
      />
     </View>
        ...
        <TouchableOpacity style={styles.loginBtn3} onPress={() => this.props.navigation.navigate('Test')}>
