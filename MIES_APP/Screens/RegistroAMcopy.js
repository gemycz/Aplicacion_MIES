    ...
    return (
        <View style={styles.logoContainer}>
            ...
            >
                ...
                {image &&
                    <Image source={{uri: image}} style={{width: 150, height: 150, borderRadius: 75, marginTop: -17}}/>}
            </TouchableOpacity>
        </View>
    );
}
            ...
            <ScrollView style={styles.scrollView}>
                <ImageBackground source={bgImage} style={styles.backgroundContainer}>
                    ...
                    <View style={{marginTop: 15}}>
                        <Text style={{fontSize: 16, textAlign: 'left', fontWeight: 'bold'}}>Seleccione una Foto de
                            Perfil</Text>
